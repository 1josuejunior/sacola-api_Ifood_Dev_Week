...
public class SacolaServiceImpl implements SacolaService {
    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
        ...
        Item.ItemBuilder itemParaSerInserido = Item.builder();
        itemParaSerInserido
        ...
        if(itensDaSacola.isEmpty()){
            itensDaSacola.add(itemParaSerInserido.build());
        } else {
            Restaurante restauranteAtual = itensDaSacola.get(0).getProduto().getRestaurante();
            Restaurante restauranteDoItemParaAdicionar = itemParaSerInserido.build().getProduto().getRestaurante();
    ...
    sacolaRepository.save(sacola);
        return itemParaSerInserido.build();
    }
